...
@section('title', 'Thêm từ khóa mới')
  ...
  <div class="col-md-6">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Thêm mới</h3>
      </div>
      <!-- /.box-header -->
      ...
      <form action="" role="form" method="POST">
        ...
        <div class="box-body">
          <div class="form-group {{ $errors->first('k_name') ? 'has-error' : '' }}">
            <label for="c_name">Tên <span class="text-danger">(*)</span></label>
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <textarea style="resize: none" rows="4" type="text" class="form-control" id="k_description"
              name="k_description" placeholder="Nhập mô tả từ khóa"></textarea>
          </div>
        </div>
        <!-- /.box-body -->
