...
@section('title', 'Thêm sản phẩm mới')
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Thêm sản phẩm mới</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
          ...
          <div class="col-md-8">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="3" placeholder="Nhập mô tả sản phẩm" name="p_description"></textarea>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="3" placeholder="Nhập nội dung sản phẩm" name="p_content"></textarea>
